...
// */
//public class PrimitiveVisitor extends RavelParserBaseVisitor<Void> {
//    IR ir;
//    Model m;
...
//        m = new Model();
//        m.setName(ctx.model_name().toString());
//        m.setmModelType(new ModelType(ctx.modelType().getText()));
//        ir.add(ctx.model_name().toString(), m);
//        System.out.println("Got Model with type: " +  ctx.modelType().getText() + " with name: " + ctx.model_name());
