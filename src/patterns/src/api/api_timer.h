 ...
 * api_timer.h
 *
 *  Autogenerated by Ravel system on: 15:52:42
 *
...
#define CONFIG_CTR__TIMER_PERIODIC APP_TIMER_TICKS(1000, APP_TIMER_PRESCALER) 		 //** Default value for the timer */
#define APP_TIMER_DEF(config_ctr__timer_periodic) 		 //** Initializing timer */
 ...
 * 
 */
void config_ctr__startTimerPeriodic(uint32_t period); 		  		  
/**
 * Stop function for config_ctr__stopTimerPeriodic
 * 
 */
void config_ctr__stopTimerPeriodic(); 		 //
