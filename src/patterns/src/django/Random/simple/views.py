...
def pushModel(request):
    ...
    if request.method == 'GET':
        ...
        reserved = int.from_bytes(data[8:9], byteorder='big')
        model_id = int.from_bytes(data[8:12], byteorder='big')
        indx = int.from_bytes(data[8:12], byteorder='big')
        field1 = int.from_bytes(data[8:12], byteorder='big')
        field2 = int.from_bytes(data[8:12], byteorder='big')
        field3 = int.from_bytes(data[8:12], byteorder='big')
        field4 = int.from_bytes(data[8:12], byteorder='big')
