...
#define BLE_UUID_RANDOM_MODEL_CHAR_UUID 0x1100
#define BLE_UUID_FREQUENCY_MODEL_CHAR_UUID 0x1101
...
{    //TODO: fix comma separation
    ...
    BLE_RANDOM_MODEL_NOTIFICATION_ENABLED,
    BLE_RANDOM_MODEL_NOTIFICATION_DISABLED,

    // replicated model have read/write
    BLE_FREQUENCY_MODEL_READ,
    BLE_FREQUENCY_MODEL_WRITE
...
typedef struct
{
    ...
    ble_gatts_char_handles_t random_model_handles; 
    ble_gatts_char_handles_t frequency_model_handles; 
