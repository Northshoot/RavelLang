...
public class ModelType extends ClassType {
    ...
    public ModelType(ModelSymbol symbol, Model.Type modelType) {
        ...
        this.addMethod("delete", new Type[]{immutableRecordType, PrimitiveType.INT32}, PrimitiveType.VOID);
        this.addMethod("create", new Type[0], recordType);
//        this.addMethod("first", new Type[0], queryRecordType);
        //TODO: deal with nullable and variable arguement calls
        this.addMethod("first", new Type[]{IntrinsicTypes.ENDPOINT.getInstanceType()}, queryRecordType);
        ...
        this.addMethod("clear", new Type[]{IntrinsicTypes.ENDPOINT.getInstanceType()}, PrimitiveType.VOID);
        this.addMethod("clearAll", new Type[0], PrimitiveType.VOID);
        this.addMethod("size", new Type[]{IntrinsicTypes.ENDPOINT.getInstanceType()}, PrimitiveType.INT32);
