 ...
 */
public class AndroidRRT extends Service implements RavelControllerInterface {

    private final static String TAG = AndroidRRT.class.getSimpleName();
...
//        devRssiValues.put(device.getAddress(), rssi);
    ...
    private void broadcastUpdate(final String action) {
        ...
        intent.setAction(AndroidRRT.BROADCAST_ACTION);
