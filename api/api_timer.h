 ...
 * api_timer.h
 *
 *  Autogenerated by Ravel system on: 19:36:55
 *
...
// defines below
#define ADDSOURCETIMER__TIMER_PERIODIC APP_TIMER_TICKS(1000, APP_TIMER_PRESCALER) 		 //** Default value for the timer */
#define APP_TIMER_DEF(addSourceTimer__timer_periodic) 		 //** Initializing timer */
...
/**
 * Stop function for addSourceTimer__stopTimerPeriodic
 * 
 */
void addSourceTimer__stopTimerPeriodic(); 		 //
