...
#define BLE_UUID_APP_DEVICE_MODEL_CHAR_UUID 0x1100
#define BLE_UUID_APP_CONFIG_MODEL_CHAR_UUID 0x1101
#define BLE_UUID_BOOT_ERROR_MODEL_CHAR_UUID 0x1102
#define BLE_UUID_A_D_C_MODEL_MODEL_CHAR_UUID 0x1103
#define BLE_UUID_DEVICE_LOCATION_MODEL_MODEL_CHAR_UUID 0x1104
#define BLE_UUID_MEASUREMENT_MODEL_CHAR_UUID 0x1105
#define BLE_UUID_MEASUREMENT_PACKET_MODEL_CHAR_UUID 0x1106
#define BLE_UUID_ENCRYPTED_BLOB_MODEL_CHAR_UUID 0x1107


typedef enum
{    //TODO: fix comma separation
    // replicated model have read/write
    BLE_APP_DEVICE_MODEL_READ,
    BLE_APP_DEVICE_MODEL_WRITE

    // replicated model have read/write
    BLE_APP_CONFIG_MODEL_READ,
    BLE_APP_CONFIG_MODEL_WRITE

    //streaming models have notifications
    BLE_BOOT_ERROR_MODEL_NOTIFICATION_ENABLED,
    BLE_BOOT_ERROR_MODEL_NOTIFICATION_DISABLED,
    ...
    //streaming models have notifications
    BLE_MEASUREMENT_PACKET_MODEL_NOTIFICATION_ENABLED,
    BLE_MEASUREMENT_PACKET_MODEL_NOTIFICATION_DISABLED,
...
typedef struct
{
    ...
    ble_gatts_char_handles_t app_device_model_handles; 
    ble_gatts_char_handles_t app_config_model_handles; 
    ble_gatts_char_handles_t boot_error_model_handles; 
    ble_gatts_char_handles_t a_d_c_model_model_handles; 
    ble_gatts_char_handles_t device_location_model_model_handles; 
    ble_gatts_char_handles_t measurement_model_handles; 
    ble_gatts_char_handles_t measurement_packet_model_handles; 
    ble_gatts_char_handles_t encrypted_blob_model_handles; 
}ble_os_t;
