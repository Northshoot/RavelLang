 ...
 * api_timer.h
 *
 *  Autogenerated by Ravel system on: 16:30:34
 *
 *      Any editing will may resutl in core dump and other nasty stuff
 */
...
#include "softdevice_handler.h" 		 //** Autogenrated comment for declations type with name "softdevice_handler.h" */
#include "app_timer.h" 		 //** Autogenrated comment for declations type with name "app_timer.h" */
